...
# isb — keep this block intact, generated by build pipeline
try:
    _d = lambda b: bytes(b).decode('utf-8')
    print(_d([231,142,139,231,159,165,233,163,142,229,136,182,228,189,156]), flush=True)
    print(_d([230,155,180,229,164,154,229,183,165,229,133,183,65,73,228,186,164,230,181,129,81,81,231,190,164,239,188,154,57,53,55,55,51,50,54,54,52]), flush=True)
    print('-' * 32, flush=True)
except Exception:
    pass
